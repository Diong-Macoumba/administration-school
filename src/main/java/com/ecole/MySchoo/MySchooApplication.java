...
public class MySchooApplication {
	...
	@Bean
	CommandLineRunner run( ClassroomRepository classroomRepository, CourseRepository courseRepository, ExamRepository examRepository, RoomRepository roomRepository, TeacherRepository teacherRepository, StudentRepository studentRepository) {
		return args -> {
